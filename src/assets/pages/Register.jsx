                ...
                <div className="row justify-content-center">
                    <ul className="nav nav-pills mb-3 flex-column flex-sm-row nav-justified register-tab col-md-6" id="pills-tab" role="tablist">
                        <li className="nav-item flex-sm-fill me-4" role="presentation">
                            <button className="nav-link btn active" id="pills-user-tab" data-bs-toggle="pill" data-bs-target="#pills-user" type="button" role="tab" aria-controls="pills-user" aria-selected="true" onClick={() => {
                                setRole(1);
                            }}>Register as User</button>
                        </li>
                        <li className="nav-item flex-sm-fill" role="presentation">
                            <button className="nav-link btn" id="pills-conselor-tab" data-bs-toggle="pill" data-bs-target="#pills-conselor" type="button" role="tab" aria-controls="pills-conselor" aria-selected="false" onClick={() => {
                                setRole(2);
                            }}>Register as Conselor</button>
                        </li>
                    </ul>
                        ...
                        <div className="tab-pane fade show active row justify-content-center" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
                            <form className="form-register" onSubmit={registerAsUser}>
                                ...
                                <div className="row mt-4">
                                    ...
                                    <div className="col">
                                        <input type="text" className="form-control" placeholder="Job" onChange={(e) => {
                                ...
                                <div className="row mt-4">
                                    <div className="col">
                                        <div className="form-floating">
                                            <textarea className="form-control" placeholder="Address" onChange={(e) => {
                                    ...
                                    <div className="col">
                                        <input type="text" className="form-control" placeholder="Phone Number" onChange={(e) => {
                        ...
                        <div className="tab-pane fade row justify-content-center" id="pills-conselor" role="tabpanel" aria-labelledby="pills-conselor-tab">
                            <form className="form-register" onSubmit={registerAsConselor}>
                                ...
                                <div className="row mt-4 border py-5 px-2 education-field justify-content-center">
                                    <div className="row">
                                        <div className="col">
                                            <input type="text" className="form-control" placeholder="Institution" onChange={(e) => {
                                                setInstitution(e.target.value);
                                            }} />
                                        </div>
                                        <div className="col">
                                            <input type="text" className="form-control" placeholder="File Url Link" onChange={(e) => {
                                    ...
                                    <div className="row mt-4">
                                        <div className="col">
                                            <input type="text" className="form-control" placeholder="Major" onChange={(e) => {
                                                setMajor(e.target.value);
                                            }} />
                                        </div>
                                        <div className="col">
                                            <input type="text" className="form-control" placeholder="GPA" onChange={(e) => {
                                    ...
                                    <div className="row mt-4">
                                        <div className="col">
                                            <input type="text" className="form-control" placeholder="Study Field" onChange={(e) => {
                                                setStudyField(e.target.value);
                                            }} />
                                        </div>
                                        <div className="col">
                                            <input type="number" className="form-control" placeholder="Graduation Year" onChange={(e) => {
