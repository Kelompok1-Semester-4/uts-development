          ...
          <div className="tab-content p-0 content" id="pills-tabContent">
                            ...
                            <button
                              onClick={() => {
                                window.location.href =
                                  "/dashboard-user/course/" + detail.course_id;
                              }}
                            ...
                            <td>
                              {transactions?.map((data) => {
                                if (data.id === transaction.id) {
                                  return (
                                    <span key={data.id}>{data.status}</span>
                                  );
                                }
                              })}
                            </td>
                  ...
                  <table className="table table-hover">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Conseling Date</th>
            ...
            >
              <div className="row justify-content-between">
                <div className="col-md-6">
                  <h2>Edit Profile</h2>
                  <h5 className="text-secondary">Edit Your Profile </h5>
                </div>
              </div>
