                                ...
                                <form>
                                    <div className="row">
                                        <div className="col-md-3">
                                            <img src="https://assets.pikiran-rakyat.com/crop/0x0:0x0/x/photo/2020/09/12/2909439885.jpg" className="img-fluid diary-image" alt="" />
                                        </div>
                                        <div className="col">
                                            <div className="row g-5">
                                                <div className="col-md">
                                                    <input type="file" className="form-control" id="cover_image" name="cover_image" placeholder="Url Cover Image" />
                                                </div>
                                                <div className="col-md">
                                            ...
                                            <div className="row g-5 mt-0">
                                                <div className="col-md">
                                                    <select name="diary-type" className="form-select" id="diary-type">
                                                ...
                                                <div className="col-md">
                                                    <input type="text" className="form-control" id="duration_read" name="duration_read" placeholder="Duration Read / minute" />
                                                </div>
                                            </div>
                                            <div className="row mt-0 g-5">
                                                <div className="col">
                                                    <div className="form-floating">
                                                        <textarea className="form-control" placeholder="content" id="content"></textarea>
                                            ...
                                            <div className="row mt-0 g-5 d-flex align-items-center">
                                                <div className="col">
                                                    <a href="/dashboard-user" className="text-decoration-none text-secondary">← Back</a>
                                                </div>
