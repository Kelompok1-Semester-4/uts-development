            ...
            <div className="container transaction">
                <div className="row d-flex align-items-center">
                    <div className="col-md-6">
                        ...
                        <img src={image_transaction} className="transaction-image mt-5" alt="" />
                    </div>
                    <div className="col-md-6">
                        <p className="text-secondary"><b className="text-black">Profile</b> •  Please fill in your data correctl </p>
                            ...
                            <div className="row d-flex align-items-end">
                                <div className="col">
                                    ...
                                    <div className="row p-2">
                                        <img src={icon_info} className="icon" alt="" />
                                        <h5 className="d-flex my-auto">I agree to the applicable Terms and Conditions.</h5>
                                    </div>
                                </div>
